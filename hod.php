...
<div class="logoutDiv">
    ...
    <div class="div1">
	<label class="title"> HOD APPROVAL </label><br><br>
    ...
    <div class="flexdiv">
		...
		<div class="buttonDiv">
		<a href="hodaccept.php?id=<?php echo $row['id'] ?>"  type="button" class="aButton" name="acceptButton" value="Approve">Approve</a>
			<a  href="hodreject.php?id=<?php echo $row['id'] ?>" type="button" class="dButton" name="declineButton" value="Decline">Decline<a>
