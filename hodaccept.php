<?php
    include('functions.php');
        ...
        $servername = "localhost:3305";
          ...
          $dbname = "jack";
          $id = $_GET['id'];
    $query = "select * from `ac_table` where `id` = '$id'; ";
    if(count(fetchAll($query)) > 0){
        foreach(fetchAll($query) as $row){
            ...
            $query = "INSERT INTO od_list ( id, date, name, roll_number, email ,department, year,section, tutor_name, from_date, to_date, purpose)
